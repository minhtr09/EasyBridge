...
contract HelperConfig is Script {
  ...
  constructor() {
    if (block.chainid == 11155111) {
      ...
      activeNetworkConfig = getRoninTestnetConfig();
    }
  }
  ...
  function getRoninTestnetConfig() public pure returns (NetworkConfig memory) {
    NetworkConfig memory roninTestnetConfig = NetworkConfig({
